rem **********************************************************************
rem $Header: svn://d02584/consolrepos/branches/AR.02.01/apc/1.0.0/sql/APCEFTWB.sql 2981 2017-11-14 08:13:57Z svnuser $
rem  %H% %A% %T%
rem
...
variable BANK_HEADER         varchar2(100) --FSC-5795
...
select '0'|| rpad(' ',17) || '01' || 'WBC' || rpad(' ',7) ||:BANK_HEADER || 
       :EFT_NO || 'SUPPLIER PAY' ||
       :PAY_DATE || rpad(' ',40)
from   dual;
...
select 	'1' 
	...
	||rpad(nvl(substr(c.ATTRIBUTE11,1,18),
	           substr(A.CHECK_NUMBER||'-DEDJTR ',1,18)),18)
        ||:BANK_BSB_NO
        ||:CHECKRUN_BANK_AC
