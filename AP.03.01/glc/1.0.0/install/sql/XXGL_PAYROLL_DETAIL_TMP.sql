rem $Header: svn://d02584/consolrepos/branches/AP.03.01/glc/1.0.0/install/sql/XXGL_PAYROLL_DETAIL_TMP.sql 2356 2017-08-30 04:07:16Z svnuser $
CREATE GLOBAL TEMPORARY TABLE FMSMGR.XXGL_PAYROLL_DETAIL_TMP
(
...
CREATE OR REPLACE SYNONYM APPS.XXGL_PAYROLL_DETAIL_TMP FOR FMSMGR.XXGL_PAYROLL_DETAIL_TMP; 
