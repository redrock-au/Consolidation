#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AP.03.01/glc/1.0.0/install/GL.03.01_install.sh 2900 2017-10-31 23:59:30Z svnuser $
# --------------------------------------------------------------
...
then
  ...
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct $IMPORTDIR/RUN_AP_CFG.ldt UPLOAD_MODE=REPLACE CUSTOM_MODE=FORCE -
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afcpreqg.lct $IMPORTDIR/XXGLREQGRP_CFG.ldt -
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/affrmcus.lct $IMPORTDIR/XXAPXSUMBA_CFG.ldt -
fi
...
cp -p $GLC_TOP/install/sql/adjust_payables.sql $PRODS
