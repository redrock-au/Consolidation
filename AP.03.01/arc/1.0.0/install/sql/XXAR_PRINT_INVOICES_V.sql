-- REM $Header: svn://d02584/consolrepos/branches/AP.03.01/arc/1.0.0/install/sql/XXAR_PRINT_INVOICES_V.sql 3181 2017-12-12 07:17:14Z svnuser $
CREATE OR REPLACE VIEW xxar_print_invoices_v
AS (
...
AND    t.printing_option = 'PRI'-- FSC-6095 08/Dec/2017         
);
