#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AR.02.03/poc/1.0.0/install/PO.04.02_install.sh 2798 2017-10-12 05:12:11Z svnuser $
# --------------------------------------------------------------
...
FNDLOAD $APPSLOGIN O Y UPLOAD $FND_TOP/patch/115/import/afmdmsg.lct $POC_TOP/import/XXICX_POR_RCV_SRCH_TABLE_TIP.ldt UPLOAD_MODE=REPLACE CUSTOM_MODE=FORCE

#Profile
FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afscprof.lct $POC_TOP/import/POC_KOFAX_ENABLED.ldt
...
mkdir -p $JAVA_TOP/doi/oracle/apps/icx/icatalog/shopping/webui/
cp -p $POC_TOP/java/doi/oracle/apps/icx/icatalog/shopping/webui/DoiNonCatalogRequestCO.java $JAVA_TOP/doi/oracle/apps/icx/icatalog/shopping/webui/
...
javac $JAVA_TOP/doi/oracle/apps/icx/icatalog/shopping/webui/DoiNonCatalogRequestCO.java
...
java oracle.jrad.tools.xml.importer.XMLImporter $CUSTOM_TOP/oaf_personalization/oracle/apps/icx/por/rcv/webui/customizations/org/101/IcxPorRcvSrchPG.xml -username apps -password $APPSPWD -dbconnection "(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=$DBHOST)(PORT=$DBPORT))(CONNECT_DATA=(SID=$DBSID)))" -rootdir $CUSTOM_TOP/oaf_personalization/ -rootPackage "/"
...
java oracle.jrad.tools.xml.importer.XMLImporter $CUSTOM_TOP/oaf_personalization/oracle/apps/icx/por/rcv/webui/customizations/responsibility/51106/IcxPorRcvHomePG.xml -username apps -password $APPSPWD -dbconnection "(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=$DBHOST)(PORT=$DBPORT))(CONNECT_DATA=(SID=$DBSID)))" -rootdir $CUSTOM_TOP/oaf_personalization/ -rootPackage "/"
...
java oracle.jrad.tools.xml.importer.XMLImporter $CUSTOM_TOP/oaf_personalization/oracle/apps/icx/icatalog/shopping/webui/customizations/site/0/NonCatalogRequestPG.xml -username apps -password $APPSPWD -dbconnection "(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=$DBHOST)(PORT=$DBPORT))(CONNECT_DATA=(SID=$DBSID)))" -rootdir $CUSTOM_TOP/oaf_personalization/ -rootPackage "/"
