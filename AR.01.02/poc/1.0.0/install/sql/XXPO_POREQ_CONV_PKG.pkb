...
/* $Header: svn://d02584/consolrepos/branches/AR.01.02/poc/1.0.0/install/sql/XXPO_POREQ_CONV_PKG.pkb 2365 2017-08-30 05:13:46Z svnuser $ */
/*******************************************************************
**
** CEMLI ID: PO.00.03
**
...
BEGIN
   ...
   LOOP
      IF r_tfm.requisition_header_id IS NOT NULL THEN
         l_status := 'SUCCESS';
