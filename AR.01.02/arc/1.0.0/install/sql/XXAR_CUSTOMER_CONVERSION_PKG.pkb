...
/*$Header: svn://d02584/consolrepos/branches/AR.01.02/arc/1.0.0/install/sql/XXAR_CUSTOMER_CONVERSION_PKG.pkb 2365 2017-08-30 05:13:46Z svnuser $*/
/****************************************************************************
**
** CEMLI ID: AR.00.01
**
...
BEGIN
   ...
   FOR i IN 1 .. t_files.COUNT LOOP
      ...
      IF p_int_mode = 'VALIDATE_TRANSFER' THEN
      --EXIT;
           -------------------------------------
