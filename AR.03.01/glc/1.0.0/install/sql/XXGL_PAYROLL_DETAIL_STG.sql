rem $Header: svn://d02584/consolrepos/branches/AR.03.01/glc/1.0.0/install/sql/XXGL_PAYROLL_DETAIL_STG.sql 1055 2017-06-21 03:20:11Z svnuser $
CREATE TABLE FMSMGR.XXGL_PAYROLL_DETAIL_STG
(
...
CREATE OR REPLACE SYNONYM APPS.XXGL_PAYROLL_DETAIL_STG FOR FMSMGR.XXGL_PAYROLL_DETAIL_STG; 
