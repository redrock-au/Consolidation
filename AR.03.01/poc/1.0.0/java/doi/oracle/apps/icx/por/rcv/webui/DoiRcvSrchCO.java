...
//
// **********************************************************************
/* $Header: svn://d02584/consolrepos/branches/AR.03.01/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 2558 2017-09-19 04:46:44Z svnuser $ */
...
public class DoiRcvSrchCO extends RcvSrchCO {
      ...
      if (isOrgKofaxEnabled(oawebbean,oapagecontext).equals("Y")) 
       { // Kofax enabled new code starts                             
         ...
         for (Row row1 = vo.first(); row1 != null; row1 = vo.next()) 
            ...
            try 
               {
                ...
                derivedQty        = String.valueOf(getDerivedValue(reqLineId,Double.parseDouble(receiptQuantity),Double.parseDouble(orderedQty),am,oawebbean,oapagecontext));                
          ...
          // receiptQuantityCol.setPrompt(lineType); //15/09/2017 Rao
             receiptQuantityCol.setPrompt("Amount(GST Excl)"); //Rao 15/09/2017
    ...
    public void processFormRequest(OAPageContext oapagecontext, OAWebBean oawebbean) {
       ...
       { // Kofax enabled new code starts
            ...
            try 
              {
                ...
                row1.setAttribute("Attribute2", String.valueOf(derivedQtyAmt));
                }  
                else
                {
                derivedQtyAmt     = (getDerivedValue(reqLineId,receiptQuantity.doubleValue(),orderedQty.doubleValue(),am,oawebbean,oapagecontext));               
        ...
        {
          if (invAmount != receiptQuantityTotal)
          {
        ...
        {
          if (invAmount != derivedQtyAmtTotal)
          {
...
public double getDerivedValue(String reqLineId, double receiptQuantity,double orderedQty,OAApplicationModule am,OAWebBean oawebbean,OAPageContext oapagecontext) 
    ...
    public static final String RCS_ID = "$Header: svn://d02584/consolrepos/branches/AR.03.01/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 2558 2017-09-19 04:46:44Z svnuser $";
    public static final boolean RCS_ID_RECORDED = VersionInfo.recordClassVersion("$Header: svn://d02584/consolrepos/branches/AR.03.01/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 2558 2017-09-19 04:46:44Z svnuser $", "oracle.apps.icx.por.rcv.webui");
