#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AP.02.02/apc/1.0.0/install/AP.02.01_install.sh 2999 2017-11-17 04:36:48Z svnuser $
# --------------------------------------------------------------
...
$ORACLE_HOME/bin/sqlplus -s $APPSLOGIN <<EOF
  ...
  @./sql/XXAP_INVOICES_RCTI_DML.sql
...
then
  ...
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct $IMPORTDIR/XXAPINVINT.ldt UPLOAD_MODE=REPLACE CUSTOM_MODE=FORCE -
