...
/* $Header: svn://d02584/consolrepos/branches/AR.00.02/arc/1.0.0/install/sql/XXAR_PRINT_INVOICES_PKG.pkb 1496 2017-07-05 07:15:13Z svnuser $ */
/******************************************************************************
**
**
...
IS
   CURSOR c_out IS
    ...
    --AND    p.request_id = p_request_id /* execute program one at time */
      ...
      AND    v.email_address IS NOT NULL
      --AND    v.transmission_method = 'EMAIL'  -- 28/Jun/2017
      AND    p.delivery_option IS NULL;  -- P for PRINT
