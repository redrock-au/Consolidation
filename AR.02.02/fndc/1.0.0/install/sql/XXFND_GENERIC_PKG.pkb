...
/* $Header: svn://d02584/consolrepos/branches/AR.02.02/fndc/1.0.0/install/sql/XXFND_GENERIC_PKG.pkb 3066 2017-11-28 06:24:56Z svnuser $ */
/*******************************************************************
**
** CEMLI ID: FND.03.01
**
...
BEGIN
   ...
   IF lv_instance in ('CONDEV','CONTEST','ERPDEV','ERPTEST','ERPUAT') THEN --FSC 5981
