#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AR.02.02/apc/1.0.0/install/AP.03.01_install.sh 2449 2017-09-06 03:50:39Z svnuser $
# --------------------------------------------------------------
...
$ORACLE_HOME/bin/sqlplus -s $APPSLOGIN <<EOF
  SET DEFINE OFF
  @./sql/XXPO_ELIGIBLE_REQUESTORS_V.sql
