...
/* $Header: svn://d02584/consolrepos/branches/AP.02.01/glc/1.0.0/install/sql/XXGL_CASH_BAL_PKG.pkb 2770 2017-10-10 23:47:18Z svnuser $ */
...
BEGIN
   ...
   IF l_cursor_switch = 1 THEN
      ...
      /******************************************************************************************
         ...
         print_debug('l_calc_amount=' || l_calc_amount);
         print_debug('l_diff_amount=' || l_diff_amount);
      ******************************************************************************************/
