#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AP.02.01/apc/1.0.0/install/AP.01.01_install.sh 1427 2017-07-04 07:19:13Z svnuser $
# --------------------------------------------------------------
...
FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct $APC_TOP/import/APCSCANRPT.ldt - WARNING=YES UPLOAD_MODE=REPLACE CUSTOM_MODE=FORCE
