...
//
// **********************************************************************
/* $Header: svn://d02584/consolrepos/branches/AP.02.01/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvRvwCO.java 2466 2017-09-06 07:00:01Z svnuser $ */
    ...
    public void processRequest(OAPageContext oapagecontext, OAWebBean oawebbean) {
      ...
      if (isOrgKofaxEnabled(oawebbean,oapagecontext).equals("Y")) 
       { // Kofax enabled new code starts
        ...
        // Added by Joy Pinto on 05-Sep-2017
        if (ReceiveReqItemsVO.getFetchedRowCount()== 0)
        {ReceiveReqItemsVO = (OAViewObject)am.findViewObject("ReceivePurchaseItemsVO");}        
