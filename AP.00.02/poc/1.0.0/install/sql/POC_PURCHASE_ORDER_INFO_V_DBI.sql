/*$Header: svn://d02584/consolrepos/branches/AP.00.02/poc/1.0.0/install/sql/POC_PURCHASE_ORDER_INFO_V_DBI.sql 1470 2017-07-05 00:33:23Z svnuser $*/
...
FROM   po_headers_all pha, 
       ...
       (SELECT sum((pd.quantity_ordered - pd.quantity_cancelled - pd.quantity_billed)*pl.unit_price) po_amount_remaining,
