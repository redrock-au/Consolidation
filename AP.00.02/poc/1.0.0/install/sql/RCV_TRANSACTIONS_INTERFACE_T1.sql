rem $Header: svn://d02584/consolrepos/branches/AP.00.02/poc/1.0.0/install/sql/RCV_TRANSACTIONS_INTERFACE_T1.sql 1161 2017-06-23 00:14:22Z svnuser $
...
BEGIN
   ...
   SET    attribute2 = v_a2,
          attribute3 = v_a3,
          attribute5 = CASE WHEN transaction_type = 'CORRECT' THEN NULL ELSE v_a5 END ,
          attribute6 = CASE WHEN transaction_type = 'CORRECT' THEN NULL ELSE v_a6 END 
