...
//
// **********************************************************************
/* $Header: svn://d02584/consolrepos/branches/AP.00.02/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 1470 2017-07-05 00:33:23Z svnuser $ */
            ...
            try 
              {
                ...
                try {
                invAmount         = Integer.parseInt(row1.getAttribute("Attribute3").toString());
                }
                catch (Exception e) {
                invAmount =0;
                }
...
public double getDerivedValue(String reqLineId, double receiptQuantity,double orderedQty,OAApplicationModule am,OAWebBean oawebbean,OAPageContext oapagecontext) 
    ...
    public static final String RCS_ID = "$Header: svn://d02584/consolrepos/branches/AP.00.02/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 1470 2017-07-05 00:33:23Z svnuser $";
    public static final boolean RCS_ID_RECORDED = VersionInfo.recordClassVersion("$Header: svn://d02584/consolrepos/branches/AP.00.02/poc/1.0.0/java/doi/oracle/apps/icx/por/rcv/webui/DoiRcvSrchCO.java 1470 2017-07-05 00:33:23Z svnuser $", "oracle.apps.icx.por.rcv.webui");
