-- $Header: svn://d02584/consolrepos/branches/AP.00.02/glc/1.0.0/sql/emprpt.sql 1470 2017-07-05 00:33:23Z svnuser $
-- arguments 1. period
...
from gl.gl_je_headers a,gl.gl_je_lines b,gl.gl_code_combinations c, empcctr f
where je_source='Payroll Accrual'
and a.period_name='&1'
and a.actual_flag='A'
