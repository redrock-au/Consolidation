#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AP.00.02/glc/1.0.0/install/GL.02.01_install.sh 1470 2017-07-05 00:33:23Z svnuser $
# --------------------------------------------------------------
...
then
  ...
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/aflvmlu.lct $IMPORTDIR/XXGL_CHRIS_ACC_DEDJTR_GL_RULES.ldt -
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/aflvmlu.lct $IMPORTDIR/XXGL_CHRIS_DEDJTR_GL_RULES.ldt -
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/aflvmlu.lct $IMPORTDIR/XXGL_CHRIS_TSC_GL_RULES.ldt -
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/aflvmlu.lct $IMPORTDIR/XXGL_CHRIS_ACC_TSC_GL_RULES.ldt -
fi
