...
/* $Header: svn://d02584/consolrepos/branches/AP.00.02/apc/1.0.0/install/sql/XXAP_PAYMENT_OUT_INT_PKG.pkb 1028 2017-06-21 01:19:01Z svnuser $ */
/*******************************************************************
**
** CEMLI ID: AP.02.03
**
...
BEGIN
   ...
   LOOP
      l_buffer := 
         ...
         enclose(r_pay.payment_method_lookup_code); 
