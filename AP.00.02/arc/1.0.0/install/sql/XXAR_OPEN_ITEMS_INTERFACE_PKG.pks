...
/* $Header: svn://d02584/consolrepos/branches/AP.00.02/arc/1.0.0/install/sql/XXAR_OPEN_ITEMS_INTERFACE_PKG.pks 1206 2017-06-23 05:38:45Z svnuser $ */
...
g_error_message_04     VARCHAR2(150)  := '<ERROR-04>CRN Number from file must be 11 digits.';
g_error_message_05     VARCHAR2(150)  := '<ERROR-05>Duplicate CRN Number within the file.';
