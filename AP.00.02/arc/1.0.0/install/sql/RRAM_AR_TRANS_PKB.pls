...
as
/* $Header: svn://d02584/consolrepos/branches/AP.00.02/arc/1.0.0/install/sql/RRAM_AR_TRANS_PKB.pls 1060 2017-06-21 03:27:14Z svnuser $ */
-- ============================================================================
--
    ...
    is
        ...
        is
            select s.stage_id
                 ...
                 , s.account_number
                 , s.party_site_number
                 , substr(hca.account_name,1,28) as account_name
          ...
          group by s.stage_id, rct.trx_number, rct.customer_trx_id, rctt.name, s.account_number, s.party_site_number
                 , substr(hca.account_name,1,28), s.source_system_ref, arps.amount_due_original
             order by 1;
