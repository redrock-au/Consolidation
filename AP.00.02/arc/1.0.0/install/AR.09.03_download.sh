...
#*******************************************************************************
#* 
#* $Header: svn://d02584/consolrepos/branches/AP.00.02/arc/1.0.0/install/AR.09.03_download.sh 1060 2017-06-21 03:27:14Z svnuser $
#* 
...
# Request Groups
#---------------------------------------
FNDLOAD apps/$DBPASS O Y DOWNLOAD $FND_TOP/patch/115/import/afcpreqg.lct $ARC_TOP/install/RECEIVABLES_ALL_rg.ldt REQUEST_GROUP \
