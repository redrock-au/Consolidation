...
/*$Header: svn://d02584/consolrepos/branches/AP.02.03/arc/1.0.0/install/sql/XXAR_CUSTOMER_INTERFACE_PKG.pkb 1442 2017-07-04 22:35:02Z svnuser $*/
/******************************************************************************
**
  ...
  BEGIN         
   ...
   CURSOR c_updated_site_on_tfm IS
       SELECT  tfm.record_id,
        ...
        AND tfm.status = 'VALIDATED'
        AND tfm.customer_name is null
        AND tfm.orig_system_customer_ref is null
        --AND tfm.customer_number is not null
