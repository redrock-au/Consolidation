#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AP.03.02/glc/1.0.0/install/GL.03.02_install.sh 1472 2017-07-05 00:35:27Z svnuser $
# --------------------------------------------------------------
...
then
  ...
  $FND_TOP/bin/FNDLOAD APPS/$APPSPWD 0 Y UPLOAD $FND_TOP/patch/115/import/aflvmlu.lct $IMPORTDIR/XXGLCOAXPAR_CFG.ldt -
