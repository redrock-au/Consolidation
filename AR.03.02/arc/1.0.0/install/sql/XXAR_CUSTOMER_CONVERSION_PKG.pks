...
/*$Header: svn://d02584/consolrepos/branches/AR.03.02/arc/1.0.0/install/sql/XXAR_CUSTOMER_CONVERSION_PKG.pks 1830 2017-07-18 00:26:50Z svnuser $*/
/****************************************************************************
**
** CEMLI ID: AR.00.01
**
...
g_error_message_39     VARCHAR2(150)  := '<ERROR-38>The ORIG SYS REF for the customer number $DTPLI_CUSTOMER_NUM  is not existing';
