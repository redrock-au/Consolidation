#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AR.03.02/arc/1.0.0/install/AR.01.02_install.sh 1382 2017-07-03 00:49:40Z svnuser $
# --------------------------------------------------------------
# Install script for AR.01.02 Receivable Transactions Interface
