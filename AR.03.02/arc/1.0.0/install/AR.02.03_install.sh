#!/usr/bin/bash
# $Header: svn://d02584/consolrepos/branches/AR.03.02/arc/1.0.0/install/AR.02.03_install.sh 1382 2017-07-03 00:49:40Z svnuser $
# --------------------------------------------------------------
...
then
  ...
  $FND_TOP/bin/FNDLOAD $APPSLOGIN 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct $IMPORTDIR/XXARRECINT.ldt -
