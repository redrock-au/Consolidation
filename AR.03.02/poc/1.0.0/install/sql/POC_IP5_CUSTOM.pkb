...
AS
/* $Header: svn://d02584/consolrepos/branches/AR.03.02/poc/1.0.0/install/sql/POC_IP5_CUSTOM.pkb 1382 2017-07-03 00:49:40Z svnuser $ */
...
BEGIN
   ...
   ELSE
         ...
         OPEN  get_po_number;
         FETCH get_po_number INTO lv_po_number;
         CLOSE get_po_number;
